...
public class ExerciseFragment extends Fragment {
    ...
    /**Activity Map**/
    private HashMap<Integer,String> label_activity = new HashMap<Integer,String>();
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction() != null) {
                if (intent.getAction().equals(Constants.ACTION.BROADCAST_MESSAGE)) {
                    ...
                    //Group 7
                    label_activity.put(1000, "Sitting");
                    label_activity.put(1001, "Walking");
                    label_activity.put(1002, "Running");
                    label_activity.put(1003, "Jumping");
                    ...
                    // Group 7
                    int label = intent.getIntExtra(Constants.KEY.ACTIVITY, 0);
                    displayClassifierActivity(label);
                }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPlot.setRangeBoundaries(-40, 40, BoundaryMode.FIXED);
    ...
    /** Group 7
     * Displays the activity generated by the classifier
     */
    private void displayClassifierActivity(final int label){
        getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                txtActivity.setText(String.format(Locale.getDefault(), getString(R.string.activity), label_activity.get(label) ));
            }
        });
    }
